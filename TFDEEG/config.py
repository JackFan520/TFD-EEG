...
def set_config():
    ...
    # Data
    parser.add_argument('--dataset', type=str, default='MEEG')
    parser.add_argument('--data-path', type=str, default=r'C:\Users\33037\Desktop\TFDEEG\example')
    ...
    parser.add_argument('--Residual_coefficient', type=float, default=0.03, choices=[0, 0.03, 0.05, 0.1, 0.3 ,0.5])#按照设备自己调整（Adjust according to the equipment itself）
    ...
    # Model Parameters
    parser.add_argument('--model', type=str, default='TFD-EEG')
    parser.add_argument('--pool', type=int, default=16)
    parser.add_argument('--pool-step-rate', type=float, default=0.25)
    parser.add_argument('--T', type=int, default=64)
    parser.add_argument('--graph-type', type=str, default='fro', choices=['fro', 'hem'])
